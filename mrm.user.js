...
(function () {
  ...
  if (navigator.userAgent.includes("Firefox")) {
    console.log(
      "Firefox detected, skipping cookie input because it's not needed."
    );
    cookiesBtn.style.display = "none";
  } else {
    console.log(
      "Cookies are required for this script to work due to Chromium limitations. See https://github.com/NYT92/mrm-downloader/tree/main?tab=readme-ov-file#using-the-script for more information."
    );
  }
