# MRM Downloader Userscript

> The userscript version only have the basic features, if you want more features, please use the extension version. I might do small update to add them but I only focus on the extension right now.

This userscript is a simple userscript that allows you to download images and videos from myreadingmanga.info. We have 2 versions of the userscript, one with no cookie check and one with cookie check due to browser random update, thing break all the time... 🤷
